...
l = df_def.columns
df_def = df_def[['anio', 'mes', 'dia', 'hora', 'temp', 'dewPt', 'heat_index', 'rh',
       'pressure', 'vis', 'wc', 'wspd', 'feels_like', 'uv_index', 'wdir_E',
       'wdir_ENE', 'wdir_ESE', 'wdir_N', 'wdir_NE', 'wdir_NNE', 'wdir_NNW',
       'wdir_NW', 'wdir_S', 'wdir_SE', 'wdir_SSE', 'wdir_SSW', 'wdir_SW',
       'wdir_VAR', 'wdir_W', 'wdir_WNW', 'wdir_WSW', 'Vviento',
       'PeriodoOlas', 'Temperatura', 'Lluvia', 'Nubosidad', 'AlturaOlas']]
...
target = df_def.iloc[:, -1]
data = df_def.iloc[:, :-1]
X_train, X_test, y_train, y_test = train_test_split(data, target, train_size=0.77)
